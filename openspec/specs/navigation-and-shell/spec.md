...
Defines the user guide coverage for the persistent application shell — the AppHeader
welcome bar and side navigation — plus the custom error page and 404 page.
