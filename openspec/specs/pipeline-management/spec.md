...
Defines the user guide coverage for the Pipelines list page: viewing configured
pipelines, searching and filtering, enabling/disabling pipelines, and navigating to edit.
