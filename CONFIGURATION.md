...
| OKTA_SCOPE                      | Space-separated OAuth scopes requested during Okta login. Must include `groups` to receive group claims for RBAC.                                       | openid email profile groups |  false   |
