...
Defines the user guide coverage for the Mappings list page: viewing configured mappings,
searching and filtering, the save success notification, and navigating to edit a mapping.
