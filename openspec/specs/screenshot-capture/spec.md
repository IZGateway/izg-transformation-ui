...
Defines a committed Playwright-based screenshot capture script that regenerates the
images referenced by the user guide, its scope and constraints, and how it is documented.
